                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        ...
                        <form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="name" name="heading"
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <textarea type="text" id="summernote" rows="5" name="description"
                            ...
                            <div class="sm:col-span-6 pt-5">
                                <button type="submit"
                                    class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">Publish</button>
                            </div>
                        </form>
                    </div>
